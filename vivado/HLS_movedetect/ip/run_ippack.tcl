...
## Variables
set Top "detec_movement"
set TopNoPrefix "detec_movement"
...
set Interfaces {
    s_axi_detec_data {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_detec_data"
        param_prefix "C_S_AXI_DETEC_DATA"
        addr_bits "10"
        port_width "AWADDR 10 WDATA 32 WSTRB 4 ARADDR 10 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x200 motion R 0x0 "Data signal of motion" {{0 8 motion R 0 "Bit 7 to 0 Data signal of motion"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x204 motion_ctrl R 0x0 "Control signal of motion" {{0 1 motion_ap_vld R 0 "Control signal motion_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x208 position R 0x0 "Data signal of position" {{0 32 position R 0 "Bit 31 to 0 Data signal of position"}}} {0x20c position_ctrl R 0x0 "Control signal of position" {{0 1 position_ap_vld R 0 "Control signal position_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x210 finished R 0x0 "Data signal of finished" {{0 8 finished R 0 "Bit 7 to 0 Data signal of finished"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x214 finished_ctrl R 0x0 "Control signal of finished" {{0 1 finished_ap_vld R 0 "Control signal finished_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "inData {base_address 256 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
