...
proc create_root_design { parentCell } {
  ...
  set lora [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 lora ]
  set pmodble [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pmodble ]
  ...
  set dphy_clk_hs_n [ create_bd_port -dir I dphy_clk_hs_n ]
  set dphy_clk_hs_p [ create_bd_port -dir I dphy_clk_hs_p ]
  ...
  set axi_dynclk_1 [ create_bd_cell -type ip -vlnv digilentinc.com:ip:axi_dynclk:1.1 axi_dynclk_1 ]
  ...
  # Create instance: detec_movement_0, and set properties
  set detec_movement_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:detec_movement:1.0 detec_movement_0 ]

  # Create instance: detectFaces_0, and set properties
  set detectFaces_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:detectFaces:1.0 detectFaces_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO3 [get_bd_intf_ports lora] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports pmodble] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_eth_GPIO [get_bd_intf_ports eth_rst_b] [get_bd_intf_pins axi_gpio_eth/GPIO]
  connect_bd_intf_net -intf_net axi_i2s_adi_1_DMA_RX_REQ [get_bd_intf_pins axi_i2s_adi_1/DMA_RX_REQ] [get_bd_intf_pins processing_system7_0/DMA0_REQ]
  connect_bd_intf_net -intf_net axi_i2s_adi_1_DMA_TX_REQ [get_bd_intf_pins axi_i2s_adi_1/DMA_TX_REQ] [get_bd_intf_pins processing_system7_0/DMA1_REQ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_DMA0_ACK [get_bd_intf_pins axi_i2s_adi_1/DMA_RX_ACK] [get_bd_intf_pins processing_system7_0/DMA0_ACK]
  connect_bd_intf_net -intf_net processing_system7_0_DMA1_ACK [get_bd_intf_pins axi_i2s_adi_1/DMA_TX_ACK] [get_bd_intf_pins processing_system7_0/DMA1_ACK]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M03_AXI [get_bd_intf_pins axi_dynclk_1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph_GP0/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M12_AXI [get_bd_intf_pins mipi_csi2_rx_subsyst_0/csirxss_s_axi] [get_bd_intf_pins ps7_0_axi_periph_GP0/M12_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI1 [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI1 [get_bd_intf_pins axi_quad_spi_0/AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI1 [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins detectFaces_0/s_axi_CONTROL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins detec_movement_0/s_axi_detec_data] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net PS_GPIO_3_Dout [get_bd_pins PS_GPIO_3/Dout] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn]
  ...
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_pins axi_dynclk_1/PXL_CLK_O] [get_bd_pins rgb2dvi_1/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_out/clk]
  connect_bd_net -net axi_dynclk_1_LOCKED_O [get_bd_pins axi_dynclk_1/LOCKED_O] [get_bd_pins rgb2dvi_1/aRst_n]
  connect_bd_net -net axi_dynclk_1_PXL_CLK_5X_O [get_bd_pins axi_dynclk_1/PXL_CLK_5X_O] [get_bd_pins rgb2dvi_1/SerialClk]
  ...
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins axi_quad_spi_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In10]
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net axi_uartlite_1_interrupt [get_bd_pins axi_uartlite_1/interrupt] [get_bd_pins xlconcat_0/In11]
  ...
  connect_bd_net -net detec_movement_0_interrupt [get_bd_pins detec_movement_0/interrupt] [get_bd_pins xlconcat_0/In13]
  connect_bd_net -net detectFaces_0_interrupt [get_bd_pins detectFaces_0/interrupt] [get_bd_pins xlconcat_0/In12]
  ...
  connect_bd_net -net mipi_csi2_rx_subsyst_0_csirxss_csi_irq [get_bd_pins mipi_csi2_rx_subsyst_0/csirxss_csi_irq] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net mipi_phy_if_clk_hs_n_0_1 [get_bd_ports dphy_clk_hs_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_hs_n]
  connect_bd_net -net mipi_phy_if_clk_hs_p_0_1 [get_bd_ports dphy_clk_hs_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_hs_p]
  connect_bd_net -net mipi_phy_if_clk_lp_n_0_1 [get_bd_ports dphy_clk_lp_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_lp_n]
  connect_bd_net -net mipi_phy_if_clk_lp_p_0_1 [get_bd_ports dphy_clk_lp_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_lp_p]
  connect_bd_net -net mipi_phy_if_data_hs_n_0_1 [get_bd_ports dphy_data_hs_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_hs_n]
  connect_bd_net -net mipi_phy_if_data_hs_p_0_1 [get_bd_ports dphy_data_hs_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_hs_p]
  connect_bd_net -net mipi_phy_if_data_lp_n_0_1 [get_bd_ports dphy_data_lp_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_lp_n]
  connect_bd_net -net mipi_phy_if_data_lp_p_0_1 [get_bd_ports dphy_data_lp_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_lp_p]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins ps7_0_axi_periph_GP0/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_1/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_eth/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_sw_btn/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_i2s_adi_1/DMA_REQ_RX_RSTN] [get_bd_pins axi_i2s_adi_1/DMA_REQ_TX_RSTN] [get_bd_pins axi_i2s_adi_1/s00_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins detec_movement_0/ap_rst_n] [get_bd_pins detectFaces_0/ap_rst_n] [get_bd_pins dvi2rgb_1/aRst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M04_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M05_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M06_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M07_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M08_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M09_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M10_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M11_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M12_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M13_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M14_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/S00_ARESETN] [get_bd_pins pwm_rgb/pwm_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_frmbuf_wr_0/ap_rst_n] [get_bd_pins v_tc_in/s_axi_aresetn] [get_bd_pins v_tc_out/s_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dynclk_1/S_AXI_LITE/S_AXI_LITE_reg] SEG_axi_dynclk_1_S_AXI_LITE_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x81200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg3
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_i2s_adi_1/S00_AXI/S00_AXI_reg] SEG_axi_i2s_adi_1_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x82C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x82C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_1/S_AXI/Reg] SEG_axi_uartlite_1_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs detec_movement_0/s_axi_detec_data/Reg] SEG_detec_movement_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs detectFaces_0/s_axi_CONTROL_BUS/Reg] SEG_detectFaces_0_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] SEG_mipi_csi2_rx_subsyst_0_Reg
