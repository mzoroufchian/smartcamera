// ==============================================================
// File generated on Thu Jul 11 10:11:39 +0200 2019
...
typedef struct {
    ...
    XDetectfaces_uio_map maps[ MAX_UIO_MAPS ];
} XDetectfaces_uio_info;

/***************** Variable Definitions **************************************/
static XDetectfaces_uio_info uio_info;
...
static int uio_info_read_name(XDetectfaces_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XDetectfaces_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XDetectfaces_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XDetectfaces_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XDetectfaces_Initialize(XDetectfaces *InstancePtr, const char* InstanceName) {
	XDetectfaces_uio_info *InfoPtr = &uio_info;
